...
> ![update the script to run on any syncthing device.png](/img/user/on/Public/attachments/update%20the%20script%20to%20run%20on%20any%20syncthing%20device.png)
